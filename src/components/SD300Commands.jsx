...
export default function SD300Commands() {
  const commands = [
    ...
    { command: 'sd300 gui', description: 'Launch or focus the native desktop app' },
    ...
    { command: 'sd300 update', description: 'Update both frontends through your existing installer; older versions may need the one-time install step below' },
