...
export default function ShaughvOSFeatures() {
  const features = [
    ...
    { title: 'Developer Tools Included', description: 'Node.js and npm come pre-installed on every image; the installer ISOs also bundle the Claude Code CLI. Start coding, automating, or building right out of the box.' },
    ...
    { title: 'Network Troubleshooting', description: '8 checks for everyday users — is my WiFi working? Is DNS resolving? How fast is my connection? 18 deep diagnostics for technicians — routing tables, TLS inspection, bufferbloat grading.' },
