...
export default function InstallGuideContent() {
  const tr300Version = useGitHubVersion('QubeTX/qube-machine-report', '3.15.3')
  const nd300Version = useGitHubVersion('QubeTX/qube-network-diagnostics', '3.0.7')
    ...
    <>
      ...
      <section id="quick-start" style={{
        ...
        <div style={{ maxWidth: '800px', width: '100%', textAlign: 'center' }}>
          ...
          <StyledTable
            ...
            rows={[
              [<Bold>TR300</Bold>, 'Machine reporting', `v${tr300Version}`],
              [<Bold>ND300</Bold>, 'Network diagnostics', `v${nd300Version}`],
              [<Bold>SD300</Bold>, 'System diagnostics', `v${sd300Version}`]
            ]}
          />
      ...
      <section id="step-2" style={{
        ...
        <div style={{ maxWidth: '900px', width: '100%' }}>
          ...
          {/* TR300 Table */}
          <SubHeading>TR300 — Machine Report Tool (v{tr300Version})</SubHeading>
          <MonoParagraph>
          ...
          {/* ND300 Table */}
          <SubHeading>ND300 — Network Diagnostics Tool (v{nd300Version})</SubHeading>
          <MonoParagraph>
