...
export default function WB300Install() {
  ...
  const platforms = {
    macos: {
      label: 'macOS',
      prompt: '$',
      comment: '# Install the prebuilt wb300 binary',
      command: unixCommand,
    ...
    windows: {
      ...
      prompt: 'PS>',
      comment: '# Install the prebuilt wb300 binary',
      command: 'irm https://reports.qubetx.com/install-wb300.ps1 | iex',
    ...
    <section id="install" style={{
      ...
      <div style={{
        ...
        <span style={{
          ...
          FROM CARGO OR SOURCE
        </span>

        <CodeBlock
          prompt="$"
          comment="# Build and install from crates.io"
          command="cargo install wb300"
        />
        <CodeBlock
          prompt="$"
          comment="# Or build from source"
          command="git clone https://github.com/QubeTX/qube-workbranch-view.git && cd qube-workbranch-view && cargo build --release"
        />
      </div>
        ...
        return (
          <div style={{
            ...
            <p style={{
              ...
              Prefer not to install Rust? Use a prebuilt Windows installer. Pick one format per edition.
            </p>
            ...
            <div style={buttonsRowStyle}>
              <DownloadButton
                href="https://github.com/QubeTX/qube-workbranch-view/releases/latest/download/wb300-x86_64-pc-windows-msvc.msi"
                label="↓ Download .MSI"
              />
              <DownloadButton
                href="https://github.com/QubeTX/qube-workbranch-view/releases/latest/download/wb300-x86_64-pc-windows-msvc-setup.exe"
                label="↓ Download .EXE"
              />
            </div>
            ...
            <div style={buttonsRowStyle}>
              <DownloadButton
                href="https://github.com/QubeTX/qube-workbranch-view/releases/latest/download/wb300-x86_64-pc-windows-msvc-corporate.msi"
                label="↓ Download .MSI"
              />
              <DownloadButton
                href="https://github.com/QubeTX/qube-workbranch-view/releases/latest/download/wb300-x86_64-pc-windows-msvc-corporate-setup.exe"
                label="↓ Download .EXE"
              />
            </div>
          </div>
      ...
      <p style={{
        ...
        PolyForm Noncommercial License • Cross-platform Git-worktree operator console
      </p>
    </section>
  )
}
