...
export default function ND300Install() {
  ...
  const platforms = {
    ...
    windows: {
      ...
      explanation: "Checks for Visual Studio C++ Build Tools (silently installs the VCTools workload via winget if missing — required by Rust on Windows), adds Cargo to this PowerShell session's PATH, installs Rust with rustup when needed, updates stable Rust, then installs ND-300 from crates.io as the nd300 package.",
      updateCommand: 'nd300 update',
