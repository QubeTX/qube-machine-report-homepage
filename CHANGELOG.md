...
- Explain CLI and app discovery after managed installation: Windows persistent-PATH/Start-menu verification, native Linux Bash/fish setup, and the distinct user/system macOS Applications destinations. Keep this update held until the corresponding SD-300 release is public.
